<?php
  class ProductInquiry extends Functions
  {
  
  	public $detail=array();
  	public $db,$rights;
  	public $ctable="product_inquiry";
  	public $primary_column="id";
  	public $unique_column="name";
  	// Public Varibale
  	public $id='';public $name='';public $email='';public $p_quantity='';public $message='';public $created_date=''; public $contact_number=''; public $category_name=''; 
  	public $valid_keys=array("id","name","email","p_qty","message","contact_no","category_name","created_date");
