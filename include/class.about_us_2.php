<?php
  class About_us extends Functions
  {
  	...
  	public $valid_keys=array("id","short_title","long_title","short_description","big_description","short_image_path","big_image_path","adate");
  				...
  				if(!empty($detail))
  				{
  					...
  					if($count<=0)
  					{
  						...
  						if(!in_array($extension, $allowedExts)){
  							...
  							$fileName = 'short_img'.substr(sha1(time()), 0, 6).".".$extension;
  							$tempPath="../images/about_short_image/".$file['short_image_path']['name'];
  							move_uploaded_file($file["short_image_path"]['tmp_name'],$tempPath);
