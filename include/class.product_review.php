<?php
  class ProductReview extends Functions
  {
  
  	public $detail=array();
  	public $db,$rights;
  	public $ctable="product_review";
  	public $primary_column="id";
  	public $unique_column="name";
  	// Public Varibale
  	public $id='';public $name='';public $email='';public $product_id='';public $comment='';public $created_date=''; public $contact_number=''; public $title=''; 
  	public $valid_keys=array("id","name","email","product_id","comment","title","created_date");
