<?php
  class Product extends Functions
  {
  	public $detail=array();
  	public $db,$rights;
  	public $ctable="veterinary";
  	public $primary_column="id";
  	public $unique_column="name";
  	// Public Varibale
  	public $id='';public $name='';public $cid='';public $sid='';public $slug='';public $packing='';public $description='';public $image_path='';public $file_upload='';public $adate='';  public $product_code='';
  	public $valid_keys=array("id","cid","sid","name","product_code","slug","packing","description","add_info","image_path","old_image_path","file_upload","old_file_upload","adate");
  				...
  				if(!empty($detail))
  				{
  					...
  					if($count<=0)
  					{
  						if (isset($file["image_path"])) 
  						{
  							...
  							$fileName = 'veterinary_product_img_'.substr(sha1(time()), 0, 6).".".$extension;
  						...
  						if(!in_array($extension, $allowedExts)){
  							...
  							$tempPath="../images/product/download_pdf/".$file['file_upload']['name'];
