...
<html lang="en">
   ...
   <head>
      <meta charset="utf-8" />
      <title><?php echo SITETITLE; ?> | Manage Product Category</title>
                           ...
                           <div class="portlet-body pull-right">
                              ...
                              <form class="form-inline"  action="#"  onSubmit="return searchByName();"role="form">
                                 <div class="form-group">
                                    <label class="sr-only" for="searchName">Search Product Category</label>
                                    <input class="form-control" id="searchName" placeholder="Enter Category Name" type="text"> 
                                 </div>
