...
<html lang="en">
  ...
  <head>
    <meta charset="utf-8" />
    <title><?php echo SITETITLE; ?> | Manage Page Table</title>
      ...
      <div class="page-container">
        ...
        <div class="page-content-wrapper">
          ...
          <div class="page-content">
            ...
            <!-- BEGIN PAGE TITLE-->
            <h1 class="page-title"> Manage Page Table
              <small>Manage Page Table</small>
            </h1>
            <!-- END PAGE TITLE-->
            <!-- END PAGE HEADER-->
            <div class="row">
              ...
              <div class="col-md-12">
                ...
                <div class="portlet light portlet-fit bordered">
                  <div class="portlet-body pull-right">
                    <h4>Search Testimonial</h4>
                    <form class="form-inline" role="form">
                      <div class="form-group">
                        <label class="sr-only" for="searchName">Search By Name</label>
                        <input class="form-control" id="searchName" placeholder="Enter Name" type="text"> 
                      </div>
                  ...
                  <div class="portlet-body">
                    <div class="table-toolbar">
                      <div class="row">
                        <div class="col-md-6">
                          <div class="btn-group">
                            <a id="add_bus" href="page_table_crud.php?mode=a" class="btn green"> Add New
