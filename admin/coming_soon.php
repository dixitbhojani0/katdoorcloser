<?php
  ...
  $main_page 	= "dashboard";
  $page 		= "Coming Soon";
  $page_title	= "Add Coming Soon";
  $page_hierarchy=array(array("link"=>"dashboard.php","title"=>"dashboard"),array("link"=>"coming_soon.php","title"=>"Coming Soon"));
  $success_msg=array();
  $error_msg=array();
  // PAGE DECLARATION
...
<html lang="en">
  ...
  <head>
    <meta charset="utf-8" />
    <title><?php echo SITETITLE; ?> | Coming Soon</title>
      ...
      <div class="page-container">
        ...
        <div class="page-content-wrapper">
          ...
          <div class="page-content">
            ...
            <!-- BEGIN PAGE TITLE-->
            <h1 class="page-title"> Coming Soon
            </h1>
            <!-- END PAGE TITLE-->
            <!-- END PAGE HEADER-->
            <!--   <div class="row">
                ...
                <div class="portlet light bordered">
                  <!--  <div class="portlet-title">
                    <div class="caption font-red-sunglo">
                        <span class="caption-subject bold uppercase"> <i class="fa fa-plus"></i> &nbsp; Add ContactUs Info</span>
                    </div>
                    <div class="actions">
