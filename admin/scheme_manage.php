...
<html lang="en">
  ...
  <head>
    <meta charset="utf-8" />
    <title><?php echo SITETITLE; ?> | Manage Scheme</title>
      ...
      <div class="page-container">
        ...
        <div class="page-content-wrapper">
          ...
          <div class="page-content">
            ...
            <!-- BEGIN PAGE TITLE-->
            <h1 class="page-title"> Manage Scheme
              ...
              <div class="col-md-12">
                ...
                <div class="portlet light portlet-fit bordered">
                  <div class="portlet-body pull-right">
                    <h5><strong>Search Scheme By Name</strong></h5>
                    <form class="form-inline"  action="#"  onSubmit="return searchByName();"role="form">
                      <div class="form-group">
                        <label class="sr-only" for="searchName">Search Scheme</label>
