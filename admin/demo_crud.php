<?php
  ...
  $main_page 	= "dashboard";
  $page 		= "category";
  $page_title	= "Add/Edit Video Gallery";
  $page_hierarchy=array(array("link"=>"dashboard.php","title"=>"dashboard"),array("link"=>"demo_manage.php","title"=>"Manage Video Gallery"),array("link"=>"demo_crud.php","title"=>"Add/Edit Video Gallery"));
  $success_msg=array();
  $error_msg=array();
  // PAGE DECLARATION
  
  // INCLUDE CLASS
  include('../include/class.demo.php');
  
  $cat_obj=new Demo();
  $mode=isset($_REQUEST['mode'])?$_REQUEST['mode']:"a";
  
  // Variable Definations
  $id='';$name='';$slug='';$title_bar='';$video_url="";$image_path="";$description="";$add_date="";
  ...
  $params['description']=$db->clean(htmlentities($_REQUEST['description']));
  	...
  	if($mode=='a')
  	{
  		...
  		if($reply['ack']==1)
  		{
              ...
              $db->rp_location("demo_manage.php");
  		}
  		else
  		{
...
<html lang="en">
  ...
  <head>
    <meta charset="utf-8" />
    <title><?php echo SITETITLE; ?> | Add/Edit Video Gallery</title>
      ...
      <div class="page-container">
        ...
        <div class="page-content-wrapper">
          ...
          <div class="page-content">
            ...
            <!-- BEGIN PAGE TITLE-->
            <h1 class="page-title"> Add/Edit Video Gallery
              <small>Add/Edit Video Gallery</small>
            </h1>
            <!-- END PAGE TITLE-->
            <!-- END PAGE HEADER-->
            <div class="row">
                  ...
                  <div class="portlet light bordered">
                    <div class="portlet-title">
                      <div class="caption font-red-sunglo">
                        <span class="caption-subject bold uppercase"> <i class="fa fa-plus"></i> &nbsp; Add/Edit Video Gallery</span>
                      </div>
                      <div class="actions">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="portlet-body form">
                          <div class="form-group">
                            ...
                            <input class="form-control " value="<?php echo $name;  ?>" name="name" id="name" type="text"  data-validation="required" data-validation-error-msg="Please enter video title.">
                            <span class="help-block"></span>
                          </div>
                          <div class="form-group">
                            <label for="video_url">Video URL <code>*</code></label>
                            <input class="form-control " value="<?php echo $video_url; ?>" name="video_url" id="video_url" type="text" data-validation="required" data-validation-error-msg="Please enter video URL." >
                            <!--<span class="help-block"></span>-->
                          </div>
                          <div class="form-group">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          <label for="logo">Select Video Image</label>
                          &nbsp;&nbsp;&nbsp;
                          <div class="portlet light bordered">
                            <div class="form-body">
                              <div class="row">
                                <div class="col-sm-12">
                                  <div class="form-group">
                                    <input data-image="<?php echo ($image_path!="" && file_exists(DEMO_A.$image_path))?DEMO_A.$image_path:"";?>" type="file" name="image_path" id="image_path" data-old-image-dom="old_image_path" data-old-image-path="<?php echo $image_path ?>" value="" >
                                  </div>
                                </div>
                              </div>
                            </div>
