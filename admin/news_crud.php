<?php
   ...
   $main_page 	= "dashboard";
   $page 		= "news";
   $page_title	= "Add/Edit News";
   $date_s = "";
   $page_hierarchy=array(array("link"=>"dashboard.php","title"=>"Dashboard"),array("link"=>"news_manage.php","title"=>"Manage News"),array("link"=>"news_crud.php","title"=>"Add/Edit News"));
   $success_msg=array();
   $error_msg=array();
   // PAGE DECLARATION
   ...
   $id='';$title='';$slug='';$description='';$image_path='';$adate='';$news_date="";
   ...
   $params['slug']=$db->rp_createSlug($_REQUEST['title']);
   $params['news_date']= $db->clean($_REQUEST['news_date']);
   ...
   $params['old_image_path']=trim($db->clean($_REQUEST['old_image_path']));
   	...
   	if($mode=='a')
   	{ 
   		//$params['news_date']=date("Y-m-d H:i:s");
   	    $reply=$news_obj->insert($params,"",$_FILES);
   		if($reply['ack']==1)
   		{			
   			$success_msg[]=$reply['ack_msg'];
               $_SESSION['success_msg']= $success_msg;
               $db->rp_location("news_manage.php");
   		}
   		else
   		{
   	...
   	else if($mode=='e')
   	{
   		...
   		$reply=$news_obj->update($params,$params['title'],$params['id'],$_FILES);
   		if($reply['ack']==1)
   		{
   			$success_msg[]=$reply['ack_msg'];
               $_SESSION['success_msg']= $success_msg;
   	...
   	else if($mode=='d')
   	{
   		...
   		$reply=$news_obj->delete(array("key"=>"id","value"=>$params['id']));
   		if($reply['ack']==1)
   		{
   		    $success_msg[]=$reply['ack_msg'];
               $_SESSION['success_msg']= $success_msg;
   	...
   	else if($mode=='ac')
   	{
   		...
   		$reply=$news_obj->active(array("key"=>"id","value"=>$params['id'],"status"=>$params['isActive']));
   		if($reply['ack']==1)
   		{
   		    $success_msg[]=$reply['ack_msg'];
               $_SESSION['success_msg']= $success_msg;
...
<html lang="en">
   ...
   <head>
      <meta charset="utf-8" />
      <title><?php echo SITETITLE; ?> | Add/Edit News</title>
   ...
   <body class="page-header-fixed page-sidebar-closed-hide-logo page-container-bg-solid page-content-white page-md">
         ...
         <div class="page-container">
            ...
            <div class="page-content-wrapper">
               ...
               <div class="page-content">
                  ...
                  <!-- BEGIN PAGE TITLE-->
                  <h1 class="page-title"> Add/Edit News
                  ...
                  <div class="row">
                     ...
                     <form role="form" action="" method="post" enctype="multipart/form-data">
                              ...
                              <div class="portlet light bordered">
                                 ...
                                 <div class="portlet-body form">
                                    ...
                                    <div class="form-group">
                                       ...
                                       <input type="text" class="form-control" name="title" id="title" value="<?php echo $title; ?>" data-validation="required,length"   data-validation-length="min3" data-validation-error-msg="Enter atleast 3 Characters."  >
                                    </div>
                                    <!-- <div class="form-group">
                                    ...
                                    <div class="form-group">
                                       <label for="title">News Date<code>*</code></label>
                                       <input type="text" class="form-control" name="news_date" id="news_date" data-validation="required" data-validation-error-msg="Please Enter News Date" value="<?php  echo $news_date; ?>"/>
                                    </div>
                                    <div class="form-group">
                                 ...
                                 <div class="portlet light bordered">
                                    ...
                                    <div class="form-body">
                                       <div class="row">
                                          <div class="col-sm-12">
                                             <div class="form-group">
                                                <label for="logo">News Image<code>*</code></label>
                                                <input data-image="<?php echo ($image_path!="" && file_exists(NEWS_A.$image_path))?NEWS_A.$image_path:"";?>" type="file" name="image_path" id="image_path" data-old-image-dom="old_image_path" data-old-image-path="<?php echo $image_path ?>" value="" >
                                             </div>
                                          </div>
                                       </div>
                                    </div>
                        ...
                        <div class="col-md-12">
                           ...
                           <button type="button" class="btn btn-primary" onClick="window.location.href='news_manage.php'">Back</button>
                        </div>
                  </div>
                  </form>
               </div>
      ...
      <script>
         ...
         $(function(){
         	...
         	aj.imageHolder($("input[name=image_path]"),"<?= NEWS_WIDTH; ?>","<?= NEWS_HEIGHT; ?>",
