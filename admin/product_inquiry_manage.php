<?php
   ...
   // INCLUDE CLASS
   include('../include/class.product_inquiry.php');
...
<html lang="en">
   ...
   <head>
      <meta charset="utf-8" />
      <title><?php echo SITETITLE; ?> | Manage Product Inquiry</title>
   ...
   <body class="page-header-fixed page-sidebar-closed-hide-logo page-container-bg-solid page-content-white page-md">
                        ...
                        <div class="portlet light portlet-fit bordered">
                           <div class="portlet-body pull-right">
                              ...
                              <form class="form-inline" action="#"  onSubmit="return searchByName();" role="form">
                                 <div class="form-group">
                                    <label class="sr-only" for="searchName">Search Product Inquiry</label>
                           ...
                           <div class="portlet-body">
                              <div class="table-toolbar">
                                 <div class="row">
                                    <button type="button" class="btn green-haze export" name="export" style="margin-left: 16px;" onClick="genReport(this)" id="export" href="" title="Download XL Report"><i class="fa fa-file-pdf-o"></i>Export</button>
                                 </div>
                              </div>
                              <div id="results">
                              </div>
      ...
      <!-- <script>
         function genReport(cid){
             ...
             $.ajax({
                 type: "POST",
                 url: "project_inquiry_genReport_ajax.php",
                 data: '&rc='+rc,
                 beforeSend: function() {
      ...
      <script>
        function genReport(){
          window.location.href='project_inquiry_genReport_ajax.php';            
        }
      </script>
   </body>
</html>