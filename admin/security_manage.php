...
<html lang="en">
  ...
  <head>
    <meta charset="utf-8" />
    <title><?php echo SITETITLE; ?> | Manage Blocked IP</title>
  ...
  <body class="page-header-fixed page-sidebar-closed-hide-logo page-container-bg-solid page-content-white page-md">
                  ...
                  <div class="portlet-body pull-right">
                    ...
                    <form class="form-inline" action="#"  onSubmit="return searchByName();" role="form">
                      <div class="form-group">
                        <label class="sr-only" for="searchName">Search by IP</label>
                        <input class="form-control" id="searchName" placeholder="Enter IP" type="text"> 
                      </div>
                  ...
                  <div class="portlet-body">
                    <!-- <div class="table-toolbar">
                      <div class="row">
                                                           <div class="col-md-6">
                                                               <div class="btn-group">
                                                                   <a id="add_bus" href="security_crud.php?mode=a" class="btn green"> Add New
    ...
    <script type="text/javascript">
      function del_conf(id){
          var r = confirm("Are you sure you want to unblock?");
          if(r){
             // window.location.href='<?php echo $ctable; ?>_crud.php?mode=d&submit=1&id='+id;
           window.location.href='<?php echo $ctable?>_manage.php?mode=delete&id='+id;
          }
      }
