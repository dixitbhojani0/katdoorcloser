      ...
      <table id="datatable_1" class="table table-striped table-bordered table-hover">
         ...
         <tbody>
            ...
            <tr>
               ...
               <td><?php echo stripslashes($ctable_d['apply_for']); ?></td>
               <td><a href="<?= SITEURL.RESUME_PATH.stripslashes($ctable_d['resume_path']) ?>" download><?php echo stripslashes($ctable_d['resume_path']); ?></a></td>

               <!-- <td align="center"><?php if($ctable_d['resume_path']!="" && file_exists(resume_A.$ctable_d['resume_path'])){
                  ?>
                  <img src="<?php echo resume_A.$ctable_d['resume_path']; ?>" width="150" height="120" />
                  <?php
                     }else{
...
<?php 				
   ...
   {
   	?>
<a class="btn btn-info btn-sm" onClick="window.location.href='resume_crud.php?mode=e&id=<?php echo $ctable_d['id']; ?>'" title="Edit"><i class="fa fa-pencil"></i></a>
<?php
   }
