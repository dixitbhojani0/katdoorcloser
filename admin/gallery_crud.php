<?php
   ...
   $page_hierarchy=array(array("link"=>"dashboard.php","title"=>"Dashboard"),array("link"=>"gallery_manage.php","title"=>"Manage Gallery"),array("link"=>"gallery_crud.php","title"=>"Add/Edit Gallery"));
   $success_msg=array();
   $error_msg=array();
   // PAGE DECLARATION
   
   // INCLUDE CLASS
   include('../include/class.gallery.php');
      ...
      $params['description']=trim($db->clean($_REQUEST['description']));
   	...
   	if($mode=='a')
   	{
   		...
   		if($reply['ack']==1)
   		{
            ...
            $db->rp_location("gallery_manage.php");
   		}
   		else
   		{
...
<html lang="en">
   ...
   <head>
      <meta charset="utf-8" />
      <title><?php echo SITETITLE; ?> | Add/Edit Gallery</title>
      ...
      <div class="page-container">
         ...
         <div class="page-content-wrapper">
            ...
            <div class="page-content">
               ...
               <!-- BEGIN PAGE TITLE-->
               <h1 class="page-title"> Add/Edit Gallery
                  ...
                  <form role="form" action="" method="post" enctype="multipart/form-data">
                     <div class="col-md-12">
                              ...
                              <div class="portlet light bordered">
                                 ...
                                 <div class="form-body">
                                    <div class="row">
                                       <div class="col-sm-12">
                                          <div class="form-group">
                                             <label for="logo">Gallery Image<code>*</code></label>
                                             <input data-image="<?php echo ($image_path!="" && file_exists(GALLERY_A.$image_path))?GALLERY_A.$image_path:"";?>" type="file" name="image_path" id="image_path" data-old-image-dom="old_image_path" data-old-image-path="<?php echo $image_path ?>" value="" >
                                          </div>
                                       </div>
                                    </div>
                                 </div>
                        ...
                        <div class="col-md-12">
                           ...
                           <button type="button" class="btn btn-primary" onClick="window.location.href='gallery_manage.php'">Back</button>
                        </div>
                     </div>
                  </form>
               </div>
