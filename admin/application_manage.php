...
<html lang="en">
   ...
   <head>
      <meta charset="utf-8" />
      <title><?php echo SITETITLE; ?> | Manage application</title>
         ...
         <div class="page-container">
            ...
            <div class="page-content-wrapper">
               ...
               <div class="page-content">
                  ...
                  <!-- BEGIN PAGE TITLE-->
                  <h1 class="page-title"> Manage application
                     <small>Manage application</small>
                  </h1>
                  <!-- END PAGE TITLE-->
                  <!-- END PAGE HEADER-->
                  <div class="row">
                     ...
                     <div class="col-md-12">
                        ...
                        <div class="portlet light portlet-fit bordered">
                           <div class="portlet-body pull-right">
                              <h5><strong>Search application By Title</strong></h5>
                              <form class="form-inline"  action="#"  onSubmit="return searchByName();"role="form">
                                 <div class="form-group">
                                    <label class="sr-only" for="searchName">Search application</label>
                           ...
                           <div class="portlet-body">
                              <div class="table-toolbar">
                                 <div class="row">
                                    <div class="col-md-6">
                                       <div class="btn-group">
                                          <a id="add_bus" href="application_crud.php?mode=a" class="btn green"> Add New
