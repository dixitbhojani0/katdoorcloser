  ...
  <table id="datatable_1" class="table table-striped table-bordered table-hover">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td align="center"><?php if($ctable_d['image_path']!="" && file_exists(DEMO_A.$ctable_d['image_path'])){
          ?>
          <img src="<?php echo DEMO_A.$ctable_d['image_path']; ?>" width="200" height="200" />
          <?php
            }else{
        ...
        <td><?php echo stripslashes($ctable_d['video_url']); ?></td>
