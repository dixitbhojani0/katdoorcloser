<?php
   ...
   // PAGE DECLARATION
   $main_page 	= "dashboard";
   $page 		= "front_popup_image";
   $page_title	= "Add/Edit Front Popup Image";
   $page_hierarchy=array(array("link"=>"dashboard.php","title"=>"Dashboard"),array("link"=>"front_popup_image_manage.php","title"=>"Manage Front Popup Image"),array("link"=>"front_popup_image_crud.php","title"=>"Add/Edit Front Popup Image"));
   $success_msg=array();
   $error_msg=array();
   // PAGE DECLARATION
   
   // INCLUDE CLASS
   include('../include/class.front_popup_image.php');
   
   $cat_obj=new FrontPopupImage();
   ...
   $params['description']=trim($db->clean($_REQUEST['description']));
   	...
   	if($mode=='a')
   	{
   		...
   		if($reply['ack']==1)
   		{
               ...
               $db->rp_location("front_popup_image_manage.php");
   		}
   		else
   		{
...
<html lang="en">
   ...
   <head>
      <meta charset="utf-8" />
      <title><?php echo SITETITLE; ?> | Add/Edit Front Popup Image</title>
   ...
   <body class="page-header-fixed page-sidebar-closed-hide-logo page-container-bg-solid page-content-white page-md">
         ...
         <div class="page-container">
            ...
            <div class="page-content-wrapper">
               ...
               <div class="page-content">
                  ...
                  <!-- BEGIN PAGE TITLE-->
                  <h1 class="page-title"> Add/Edit Front Popup Image
                     <small>Add/Edit Front Popup Image</small>
                  </h1>
                  <!-- END PAGE TITLE-->
                  <!-- END PAGE HEADER-->
                  <div class="row">
                  ...
                  <div class="row">
                     ...
                     <form role="form" action="" method="post" enctype="multipart/form-data">
                                 ...
                                 <div class="portlet light bordered">
                                    ...
                                    <div class="form-body">
                                       <div class="row">
                                          <div class="col-sm-12">
                                             <div class="form-group">
                                                <label for="logo">Fornt Popup Image<code>*</code></label>
                                                <input data-image="<?php echo ($image_path!="" && file_exists(FRONT_POPUP_IMAGE_A.$image_path))?FRONT_POPUP_IMAGE_A.$image_path:"";?>" type="file" name="image_path" id="image_path" data-old-image-dom="old_image_path" data-old-image-path="<?php echo $image_path ?>" value="" >
                                             </div>
                                          </div>
                                       </div>
                                    </div>
                        ...
                        <div class="col-md-12">
                           ...
                           <button type="button" class="btn btn-primary" onClick="window.location.href='front_popup_image_manage.php'">Back</button>
                        </div>
                  </div>
                  </form>
               </div>
      ...
      <script>
         ...
         $(function(){
         	...
         	aj.imageHolder($("input[name=image_path]"),"<?= FRONT_POPUP_IMAGE_WIDTH; ?>","<?= FRONT_POPUP_IMAGE_HEIGHT;?>",
