      ...
      <table id="datatable_1" class="table table-striped table-bordered table-hover">
         ...
         <tbody>
            ...
            <tr>
               ...
               <td align="center"><?php if($ctable_d['image_path']!="" && file_exists(SUBCATEGORY_A.$ctable_d['image_path'])){
                  ?>
                  <img src="<?php echo SUBCATEGORY_A.$ctable_d['image_path']; ?>" width="150" height="120" />
                  <?php
                     }else{
               ...
               <td><?php echo $db->rp_getValue("category","name","id='".$ctable_d['cid']."'",0); ?></td>
               <td align="center">
               ...
               <td>
                  <?php 				
                     ...
                     {
                     	?>
                  <a class="btn btn-info btn-sm" onClick="window.location.href='subcategory_crud.php?mode=e&id=<?php echo $ctable_d['id']; ?>'" title="Edit"><i class="fa fa-pencil"></i></a>
                  <?php
                     }
                     ...
                     <ul class="dropdown-menu" role="menu">
                        <li>
                           <?php
                              ...
                              ?>
                           <a  href="subcategory_crud.php?mode=ac&submit=1&id=<?php echo $ctable_d['id']; ?>&status=1" title="Activate"><span class="text-success"><i class="fa fa-circle"></i> &nbsp;Activate</span></a>
                           <?php
                              }else{
                              ?>
                           <a  href="subcategory_crud.php?mode=ac&submit=1&&id=<?php echo $ctable_d['id']; ?>&status=0" title="Deactivate"><span class="text-danger" ><i class="fa fa-circle-o"></i> &nbsp; Deactivate </span></a>
                           <?php
                              }
                              ?>
                        </li>
