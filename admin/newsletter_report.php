<?php
  ...
  $ctable 	= "newsletter";
  $ctable1 	= "Newsletter Report";
  $main_page 	= "product_mgmt";
  $page 		= "manage_".$ctable;
  $page_title = "".$ctable1;
  $page_hierarchy=array();
  include("connect.php");
  $admin_details=$db->getCurrentUserDetail();
  $reg_year=date("Y",strtotime($admin_details['adate']));
  $curr_year=date("Y");
  ?>
<!DOCTYPE html>
<html lang="en">
  ...
  <head>
    <meta charset="utf-8" />
    <title><?php echo SITETITLE; ?> | Newsletter Report</title>
  ...
  <body class="page-header-fixed page-sidebar-closed-hide-logo page-container-bg-solid page-content-white page-md">
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <div class="portlet-body pull-right">
                          <h5><strong>Search By Email</strong></h5>
    ...
    <script type="text/javascript">
      var searchName="";
      var data_url = "newsletter_report_get_ajax_view.php";
