...
<html lang="en">
  ...
  <head>
    <meta charset="utf-8" />
    <title><?php echo SITETITLE; ?> | Manage Dealer</title>
      ...
      <div class="page-container">
        ...
        <div class="page-content-wrapper">
          ...
          <div class="page-content">
            ...
            <!-- BEGIN PAGE TITLE-->
            <h1 class="page-title"> Manage Dealer
              <small>Manage Dealer</small>
            </h1>
            <!-- END PAGE TITLE-->
            <!-- END PAGE HEADER-->
            <div class="row">
                  ...
                  <div class="portlet-body pull-right">
                    ...
                    <form class="form-inline"  action="#"  onSubmit="return searchByName();"role="form">
                      <div class="form-group">
                        <label class="sr-only" for="searchName">Search Dealer</label>
                        <input class="form-control" id="searchName" placeholder="Enter Dealer Name" type="text"> 
                      </div>
