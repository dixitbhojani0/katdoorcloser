         ...
         <tr>
            ...
            <td>
               <?php
                  ...
                  ?>
               <img src="<?php echo BANNER_A.$ctable_d['image_path']; ?>" width="150" height="120" />
               <?php
                  }else{
            ...
            <td>
               <a class="btn btn-info btn-sm" onClick="window.location.href='banner_crud.php?mode=e&id=<?php echo $ctable_d['id']; ?>'" title="Edit"><i class="fa fa-pencil"></i></a>
