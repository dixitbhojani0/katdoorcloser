<?php
   ...
   $main_page 	= "dashboard";
   $page 		= "SubCategory";
   $page_title	= "Add/Edit Subcategory";
   $page_hierarchy=array(array("link"=>"dashboard.php","title"=>"Dashboard"),array("link"=>"subcategory_manage.php","title"=>"Manage SubCategory"),array("link"=>"subcategory_crud.php","title"=>"Add/Edit SubCategory"));
   $success_msg=array();
   $error_msg=array();
   // PAGE DECLARATION
   
   // INCLUDE CLASS
   include('../include/class.subcategory.php');
   
   $subcategory_obj=new SubCategory();
   $mode=isset($_REQUEST['mode'])?$_REQUEST['mode']:"a";
   
   // Variable Definations
   $id='';$cid='';$sid='';$name='';$slug='';$meta_descr="";$price="";$image_path="";$short_image_path="";$description="";$add_date="";$file_upload="";
   ...
   // $params['old_short_image_path']=trim($db->clean($_REQUEST['old_short_image_path']));
   ...
   //$params['price']=$db->clean($_REQUEST['price']);
   	...
   	if($mode=='a')
   	{
   	    ...
   	    $reply=$subcategory_obj->insert($params,"",$_FILES,$_FILES);
   		if($reply['ack']==1)
   		{
   			$success_msg[]=$reply['ack_msg'];
               $_SESSION['success_msg']= $success_msg;
               $db->rp_location("subcategory_manage.php");
   		}
   		else
   		{
   	...
   	{
   		$reply=$subcategory_obj->update($params,"",$params['id'],$_FILES,$_FILES);
   		if($reply['ack']==1)
   		{
   			$success_msg[]=$reply['ack_msg'];
               $_SESSION['success_msg']= $success_msg;
   	...
   	else if($mode=='d')
   	{
   		...
   		$reply=$subcategory_obj->delete(array("key"=>"id","value"=>$params['id']));
   		if($reply['ack']==1)
   		{
   		    $success_msg[]=$reply['ack_msg'];
               $_SESSION['success_msg']= $success_msg;
   	...
   	else if($mode=='ac')
   	{
   	   //
   		...
   		$reply=$subcategory_obj->active(array("key"=>"id","value"=>$params['id'],"status"=>$params['status']));
   		if($reply['ack']==1)
   		{
   		    $success_msg[]=$reply['ack_msg'];
               $_SESSION['success_msg']= $success_msg;
   ...
   if($mode=="e")
   {
   	...
   	// GET REQUIRED VALUE FROM DATABASE
   	   ...
   	   $id=trim($db->clean($_REQUEST['id']));
   		...
   		$reply=$subcategory_obj->view("id='".$id."'");
   		if($reply['ack']==1)
   		{
...
<html lang="en">
   ...
   <head>
      <meta charset="utf-8" />
      <title><?php echo SITETITLE; ?> | Add/Edit Sub Category</title>
   ...
   <body class="page-header-fixed page-sidebar-closed-hide-logo page-container-bg-solid page-content-white page-md">
         ...
         <div class="page-container">
            ...
            <div class="page-content-wrapper">
               ...
               <div class="page-content">
                  ...
                  <!-- BEGIN PAGE TITLE-->
                  <h1 class="page-title"> Add/Edit Sub Category
                           ...
                           <div class="col-md-6">
                              <div class="portlet light bordered">
                                 ...
                                 <div class="portlet-body form">
                                       ...
                                       <select class="form-control" name="cid" id="cid" onChange="getSubCat(this.value);" >
                                          ...
                                          <?php
                                             ...
                                             if(mysqli_num_rows($cat_r)>0){
                                             	...
                                             	?>
                                          <option value="<?php echo $cat_d['id']; ?>" <?php if($cat_d['id']==$cid){echo "selected"; } ?>><?php echo $cat_d['name']; ?></option>
                                          <?php
                                             }
                                             }
                                             ?>
                                    ...
                                    <div class="form-group">
                                       <label for="name">SubCategory Name <code>*</code></label>
                                    ...
                                    <div class="form-actions noborder">
                                       ...
                                       <button type="button" class="btn btn-primary" onClick="window.location.href='subcategory_manage.php'">Back</button>
                                    </div>
                                 </div>
                              </div>
                           </div>
                                 ...
                                 <div class="portlet light bordered">
                                    ...
                                    <div class="form-body">
                                       <div class="row">
                                          <div class="col-sm-12">
                                             <div class="form-group">
                                                <lable>Select SubCategory Image</lable>
                                                <input data-image="<?php echo ($image_path!="" && file_exists(SUBCATEGORY_A.$image_path))?SUBCATEGORY_A.$image_path:"";?>" type="file" accept="image/*" name="image_path" id="image_path" data-old-image-dom="old_image_path"  data-old-image-path="<?php echo $image_path ?>" value="" >
                                             </div>
                                          </div>
                                       </div>
                                    </div>
      ...
      <script>
         ...
         $(function(){
         	aj.imageHolder($("input[name=image_path]"),"<?= SUBCATEGORY_IMAGE_WIDTH; ?>","<?= SUBCATEGORY_IMAGE_HEIGHT ?>",
