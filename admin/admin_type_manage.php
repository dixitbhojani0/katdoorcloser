...
<html lang="en">
  ...
  <head>
    <meta charset="utf-8" />
    <title><?php echo SITETITLE; ?> | Manage Admin Type</title>
      ...
      <div class="page-container">
        ...
        <div class="page-content-wrapper">
          ...
          <div class="page-content">
            ...
            <!-- BEGIN PAGE TITLE-->
            <h1 class="page-title"> Manage Admin Type
              <small>Manage Admin Type</small>
            </h1>
            <!-- END PAGE TITLE-->
            <!-- END PAGE HEADER-->
            <div class="row">
                  ...
                  <div class="portlet-body pull-right">
                    ...
                    <form class="form-inline" role="form">
                      <div class="form-group">
                        ...
                        <input class="form-control" id="searchName" placeholder="Enter By Name" type="text"> 
                      </div>
                  ...
                  <div class="portlet-body">
                    <div class="table-toolbar">
                      <div class="row">
                        <div class="col-md-6">
                          <div class="btn-group">
                            <a id="add_bus" href="admin_type_crud.php?mode=a" class="btn green"> Add New
