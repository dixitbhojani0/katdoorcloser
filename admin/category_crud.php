<?php
   ...
   $page_hierarchy=array(array("link"=>"dashboard.php","title"=>"Dashboard"),array("link"=>"category_manage.php","title"=>"Manage Category"),array("link"=>"category_crud.php","title"=>"Add/Edit Category"));
   $success_msg=array();
   $error_msg=array();
   // PAGE DECLARATION
   	...
   	if($mode=='a')
   	{
         // print_r($params);exit;
   		...
   		if($reply['ack']==1)
   		{
               ...
               $db->rp_location("category_manage.php");
   		}
   		else
   		{
                              ...
                              <div class="portlet light bordered">
                                 ...
                                 <div class="portlet-body form">
                                    ...
                                    <div class="form-actions noborder">
                                       ...
                                       <button type="button" class="btn btn-primary" onClick="window.location.href='category_manage.php'">Back</button>
                                    </div>
                                 </div>
                              </div>
                           </div>
                                       ...
                                       <div class="row">
                                          <div class="col-sm-12">
                                             <div class="form-group">
                                                ...
                                                <input data-image="<?php echo ($image_path!="" && file_exists(CATEGORY_A.$image_path))?CATEGORY_A.$image_path:"";?>" type="file" accept="image/*" name="image_path" id="image_path" data-old-image-dom="old_image_path"  data-old-image-path="<?php echo $image_path ?>" value="" >
                                             </div>
                                          </div>
                                       </div>
                                    </div>
