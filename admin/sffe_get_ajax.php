      ...
      <table id="datatable_1" class="table table-striped table-bordered table-hover">
         ...
         <tbody>
            ...
            <tr>
               ...
               <td align="center"><?php if($ctable_d['image_path']!="" && file_exists(BLOG_A.$ctable_d['image_path'])){
                  ?>
                  <img src="<?php echo BLOG_A.$ctable_d['image_path']; ?>" width="150" height="120" />
                  <?php
                     }else{
                     echo "No Image Available.";
                     }?>
               </td>
               <td><span class="<?php echo ($ctable_d['isActive']==0)?"text-danger":"text-success"; ?>"><?php echo stripslashes($ctable_d['blog_title']); ?></span></td>
