<?php 
  ...
  if(isset($scheck_res->num_rows) && mysqli_num_rows($scheck_res)>0){
  	//404
  	...
  	// var_dump($_REQUEST);exit;
  	$where = "username='".$_REQUEST['username']."' and password='".md5($_REQUEST['password'])."' AND admin_type=0 ";
  	...
  	if($res){  
        ...
        ";
  		...
  		if(isset($res22->num_rows) && mysqli_num_rows($res22)>0){
  			//update
