...
<html lang="en">
  ...
  <head>
    <meta charset="utf-8" />
    <title><?php echo SITETITLE; ?> | Manage Video Gallery</title>
      ...
      <div class="page-container">
        ...
        <div class="page-content-wrapper">
          ...
          <div class="page-content">
            ...
            <!-- BEGIN PAGE TITLE-->
            <h1 class="page-title"> Manage Video Gallery
                  ...
                  <div class="portlet-body pull-right">
                    ...
                    <form class="form-inline"  action="#"  onSubmit="return searchByName();"role="form">
                      <div class="form-group">
                        <label class="sr-only" for="searchName">Search Video</label>
                        <input class="form-control" id="searchName" placeholder="Enter Video Name" type="text"> 
                      </div>
