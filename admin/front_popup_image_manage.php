<?php
   ...
   // PAGE DECLARATION
   $main_page 	= "dashboard";
   $page 		= "Front Popup Image";
   $ctable 		= "front_popup_image";
   $page_title	= "Manage Front Popup Image";
...
<html lang="en">
   ...
   <head>
      <meta charset="utf-8" />
      <title><?php echo SITETITLE; ?> | Manage Front Popup Image</title>
   ...
   <body class="page-header-fixed page-sidebar-closed-hide-logo page-container-bg-solid page-content-white page-md">
         ...
         <div class="page-container">
            ...
            <div class="page-content-wrapper">
               ...
               <div class="page-content">
                  ...
                  <!-- BEGIN PAGE TITLE-->
                  <h1 class="page-title"> Manage Front Popup Image
                     <small>Manage Front Popup Image</small>
                  </h1>
                  <!-- END PAGE TITLE-->
                  <!-- END PAGE HEADER-->
                  <div class="row">
                     ...
                     <div class="col-md-12">
                        ...
                        <div class="portlet light portlet-fit bordered">
                           <div class="portlet-body pull-right">
                              <h5><strong>Search Front Popup Image By Title</strong></h5>
                              <form class="form-inline"  action="#"  onSubmit="return searchByName();"role="form">
                                 <div class="form-group">
                                    <label class="sr-only" for="searchName">Search Gallery</label>
                           ...
                           <div class="portlet-body">
                              <div class="table-toolbar">
                                 <div class="row">
                                    <div class="col-md-6">
                                       <div class="btn-group">
                                          <a id="add_bus" href="front_popup_image_crud.php?mode=a" class="btn green"> Add New
      ...
      <script>
         //for excel sheet genrate
         function genReport1(){
         	var rc = encodeURIComponent($("#print_info").html());
         	$.ajax({
         		type: "POST",
         		url: "category_exel.php",
         		data: '&rc='+rc,
         		beforeSend: function() {
