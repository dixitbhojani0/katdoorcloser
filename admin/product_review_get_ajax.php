         ...
         <table id="datatable_1" class="table table-striped table-bordered table-hover">
            ...
            <tbody>
               ...
               <tr>
                  ...
                  <td><?php echo stripslashes($ctable_d['comment']); ?></td>
                  ...
                  <td>
                     ...
                     <?php
                        ...
                        ?>
                     <!-- <a class="btn btn-info btn-sm" onClick="window.location.href='<?php echo $ctable; ?>product_review_crud.php?mode=e&id=<?php echo $ctable_d['id']; ?>'" title="Edit"><i class="fa fa-pencil"></i></a> --> 
                  </td>
               </tr>
               <?php
                  }
