      ...
      <table id="datatable_1" class="table table-striped table-bordered table-hover">
         ...
         <tbody>
            ...
            <tr>
               ...
               <td align="center"><?php if($ctable_d['image_path']!="" && file_exists(PRODUCT_A.$ctable_d['image_path'])){
                  ?>
                  <img src="<?php echo PRODUCT_A.$ctable_d['image_path']; ?>" width="150" height="120" />
                  <?php
                     }else{
               ...
               <!-- <td><?php echo $db->rp_getValue("sub_category","name","id='".$ctable_d['sid']."'",0); ?></td> -->
               <td align="center">
