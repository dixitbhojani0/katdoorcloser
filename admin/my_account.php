<?php
  ...
  $page_hierarchy=array(array("link"=>"dashboard.php","title"=>"Deshboard"),array("link"=>"my_account.php","title"=>"Profile"));
  // For Submit
  $name		= "";
  $username		= "";
  $email			= "";
  ...
  if(isset($_REQUEST['submit3'])){
  	...
  	$password		= md5(trim($_REQUEST['rpassword']));
  	$rows 	= array("username"=>$username,"password"=>$password);
  	$where	= "admin_type='1'";
  	$db->rp_update(CTABLE_ADMIN,$rows,$where,0);
  	$success_msg[]="Reception Password successfully changed!!";
  	$_SESSION['success_msg']=$success_msg;
  	$db->rp_location("my_account.php?msg=1");
  }
                ...
                <div class="profile-sidebar">
                  ...
                  <div class="portlet light profile-sidebar-portlet ">
                    ...
                    <div class="profile-userpic">
                      <img src="<?php echo $loggedInUser['image_path']?>" class="img-responsive" alt=""> 
                    </div>
                    <!-- END SIDEBAR USERPIC -->
                    <!-- SIDEBAR USER TITLE -->
                      ...
                      <div class="portlet light ">
                        <div class="portlet-title tabbable-line">
                          ...
                          <ul class="nav nav-tabs">
                            ...
                            <!-- <li>
                              <a href="#tab_1_4" data-toggle="tab">Change Reception Password</a>
                              </li>  -->
                            <!-- <li>
                              <a href="security_manage.php">Blocked Ip</a>
                              </li>   	 -->													
                          </ul>
                        </div>
                        <div class="portlet-body">
                          <div class="tab-content">
                              ...
                              <form role="form" action="" onSubmit="return check_form();" method="post">
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="input-group input-group-sm">
                                    ...
                                    <input type="text" name="twitter" id="twitter" placeholder="Twitter id" value="<?php echo $loggedInUser['twitter']; ?>" class="form-control" />
                                    <p class="help-block"></p>
                                  </div>
                                </div>
                                <div class="form-group">
                                  ...
                                  <div class="input-group input-group-sm">
                                    ...
                                    <input type="text" name="facebook" id="facebook" placeholder="Facebook id" value="<?php echo $loggedInUser['facebook']; ?>" class="form-control" />
                                    <p class="help-block"></p>
                                  </div>
                                </div>
                            ...
                            <div class="tab-pane" id="tab_1_4">
                              <form role="form" action="" onSubmit="return check_form3();" method="post">
                                <div class="form-group">
                                  <label class="control-label">Reception username</label>
                                  <input name="rusername" id="username" type="text" placeholder="Reception username" value="" class="form-control" /> 
                                  <p class="help-block"></p>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="margin-top-10">
                                  <button name="submit3" type="submit" class="btn green"> Change Reception Password </button>&nbsp;
                                </div>
                              </form>
                            </div>
                            ...
                            <div class="tab-pane" id="tab_1_3">
                              <form role="form" action="" onSubmit="return check_form2();" method="post">
                                <div class="form-group">
                                  ...
                                  <input name="opassword" id="opassword" type="password" class="form-control" />
                                  <p class="help-block"></p>
                                </div>
                                <div class="form-group">
                                  <label class="control-label">New Password</label>
    ...
    <script>
      ...
      function check_form2(){
      	...
      	if($("#cpassword").val()=="" || $("#cpassword").val().split(" ").join("")==""){
      		alert("cpassword","Please enter confirm password.");
      ...
      function check_form3(){
      	var isValid=true;
      	if($("#rusername").val()=="" || $("#rusername").val().split(" ").join("")==""){
      		alert("Please enter username for reception.");
      		isValid=false;
      	}
      	if($("#rpassword").val()=="" || $("#rpassword").val().split(" ").join("")==""){
      		alert("Please enter new password for reception.");
      		isValid=false;
      	}
