...
$main_page 	= "dashboard";
$page 		= "Client";
$page_title	= "Add/Edit Client";
$page_hierarchy=array(array("link"=>"dashboard.php","title"=>"Dashboard"),array("link"=>"client_slider_manage.php","title"=>"Manage Client"),array("link"=>"client_slider_crud.php","title"=>"Add/Edit Client"));
$success_msg=array();
$error_msg=array();
// PAGE DECLARATION

// INCLUDE CLASS
include('../include/class.clientslider.php');

$Obj=new ClientSlider();
$mode=isset($_REQUEST['mode'])?$_REQUEST['mode']:"a";

// Variable Definations
$id='';$cid='';$sid='';$name='';$slug='';$meta_descr="";$price="";$image_path="";$description="";$add_date="";
   ...
   $params['old_image_path']=trim($db->clean($_REQUEST['old_image_path']));    
	...
	{ 
		...
		if($reply['ack']==1)
		{
            ...
            $db->rp_location("client_slider_manage.php");
		}
		else
		{
...
<html lang="en">
   ...
   <head>
      <meta charset="utf-8" />
      <title><?php echo SITETITLE; ?> | Add/Edit Client</title>
   ...
   <body class="page-header-fixed page-sidebar-closed-hide-logo page-container-bg-solid page-content-white page-md">
         ...
         <div class="page-container">
            ...
            <div class="page-content-wrapper">
               ...
               <div class="page-content">
                  ...
                  <!-- BEGIN PAGE TITLE-->
                  <h1 class="page-title"> Add/Edit Client
                  ...
                  <div class="row">
                     ...
                     <form role="form" action="" method="post" enctype="multipart/form-data">
                              ...
                              <div class="portlet light bordered">
                                 ...
                                 <div class="portlet-body form">
                                    <div class="form-group">
                                       <label for="name">Client Name <code>*</code></label>
                                 ...
                                 <div class="portlet light bordered">
                                    ...
                                    <div class="form-body">
                                       <div class="row">
                                          <div class="col-sm-12">
                                             <div class="form-group">
                                                <label for="logo">Image<code>*</code></label>
                                                <input data-image="<?php echo ($image_path!="" && file_exists(CLIENT_A.$image_path))?CLIENT_A.$image_path:"";?>" type="file" name="image_path" id="image_path" data-old-image-dom="old_image_path" data-old-image-path="<?php echo $image_path ?>" value="" >
                                             </div>
                                          </div>
                                       </div>
                                    </div>
                        ...
                        <div class="col-md-12">
                           ...
                           <button type="button" class="btn btn-primary" onClick="window.location.href='client_slider_manage.php'">Back</button>
                        </div>
                  </div>
                  </form>
               </div>
      ...
      <script>         
         ...
         $(function(){
         	...
         	aj.imageHolder($("input[name=image_path]"),"<?= CLIENT_IMAGE_WIDTH; ?>","<?= CLIENT_IMAGE_HEIGHT; ?>",
