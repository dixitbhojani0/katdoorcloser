<?php
    ...
    */
   include("connect.php");
   $ctable 	= "front_popup_image";
   $ctable1 	= "Front_Popup_Image";
      ...
      <table id="datatable_1" class="table table-striped table-bordered table-hover">
         ...
         <tbody>
            ...
            <tr>
               ...
               <td align="center"><?php if($ctable_d['image_path']!="" && file_exists(FRONT_POPUP_IMAGE_A.$ctable_d['image_path'])){
                  ?>
                  <img src="<?php echo FRONT_POPUP_IMAGE_A.$ctable_d['image_path']; ?>" width="150" height="120" />
                  <?php
                     }else{
                     echo "No Image Available.";
                     }?>
               </td>
               <td><span class="<?php echo ($ctable_d['isActive']==0)?"text-danger":"text-success"; ?>"><?php echo stripslashes($ctable_d['title']); ?></span></td>
               <td><?php echo html_entity_decode($ctable_d['description']); ?></td>
               <!-- <td><?php echo date('d-m-y h:i a',strtotime($ctable_d['adate'])); ?></td> -->
</div>
<td>
<?php 				
   ...
   {
   	?>
<a class="btn btn-info btn-sm" onClick="window.location.href='front_popup_image_crud.php?mode=e&id=<?php echo $ctable_d['id']; ?>'" title="Edit"><i class="fa fa-pencil"></i></a>
<?php
   }
