    ...
    <table id="datatable_1" class="table table-striped table-bordered table-hover">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td align="center"><?php if($ctable_d['image_path']!="" && file_exists(SERVICE_CATEGORY_A.$ctable_d['image_path'])){
            ?>
            <img src="<?php echo SERVICE_CATEGORY_A.$ctable_d['image_path']; ?>" width="100" height="100" />
            <?php
              }else{
          ...
          <!--<td><?php echo stripslashes($ctable_d['d_type']); ?></td>-->
