...
<div id="print_info">
   <form action="" name="frm" id="frm" method="post">
      <div class="table-responsive">
         <table id="divatatable_1" class="table table-striped table-bordered table-hover">
            <thead>
               <tr>
                  <th>ID</th>
                  <!-- <th>CID</th> -->
            ...
            <tbody>
               ...
               <tr>
                  ...
                  <td align="center"><?php if($ctable_d['image_path']!="" && file_exists(TEAM_A.$ctable_d['image_path'])){
                     ?>
                     <img src="<?php echo TEAM_A.$ctable_d['image_path']; ?>" width="100" height="100" />
                     <?php
                        }else{
                  ...
                  <td>
                     ...
                     {
                     ?>
                     <a class="btn btn-info btn-sm" onClick="window.location.href='our_team_crud.php?mode=e&id=<?php echo $ctable_d['id']; ?>'" title="Edit"><i class="fa fa-pencil"></i></a>
                     <?php
                     }
