...
<html lang="en">
   ...
   <head>
      <meta charset="utf-8" />
      <title><?php echo SITETITLE; ?> | Manage Product SubCategory</title>
   ...
   <body class="page-header-fixed page-sidebar-closed-hide-logo page-container-bg-solid page-content-white page-md">
                     ...
                     <div class="col-md-12">
                        ...
                        <div class="portlet light portlet-fit bordered">
                           <div class="portlet-body pull-right">
                              <h4>Search SubCategory</h4>
                              <form class="form-inline"  action="#"  onSubmit="return searchByName();"role="form">
                                 <div class="form-group">
                                    <label class="sr-only" for="searchName">Search SubCategory</label>
                                    <input class="form-control" id="searchName" placeholder="Enter SubCategory Name" type="text"> 
                                 </div>
                           ...
                           <div class="portlet-body">
                              <div class="table-toolbar">
                                 <div class="row">
                                    <div class="col-md-6">
                                       <div class="btn-group">
                                          <a id="add_bus" href="subcategory_crud.php?mode=a" class="btn green"> Add New
      ...
      <script type="text/javascript">
         var searchName="";
         var data_url = "subcategory_get_ajax.php";
      ...
      <script type="text/javascript">
         function del_conf(id){
         	...
         	if(r){
         		window.location.href='subcategory_crud.php?mode=d&submit=1&id='+id;
         	}
         }
      </script>
      <!-- END PAGELEVEL JS -->
