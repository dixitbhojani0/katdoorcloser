      ...
      <table id="datatable_1" class="table table-striped table-bordered table-hover">
         ...
         <tbody>
            ...
            <tr>
               ...
               <td align="center"><?php if($ctable_d['image_path']!="" && file_exists(application_A.$ctable_d['image_path'])){
                  ?>
                  <img src="<?php echo application_A.$ctable_d['image_path']; ?>" width="150" height="120" />
                  <?php
                     }else{
...
<?php 				
   ...
   {
   	?>
<a class="btn btn-info btn-sm" onClick="window.location.href='application_crud.php?mode=e&id=<?php echo $ctable_d['id']; ?>'" title="Edit"><i class="fa fa-pencil"></i></a>
<?php
   }
