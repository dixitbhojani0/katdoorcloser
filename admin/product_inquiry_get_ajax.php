<?php
    ...
    */
   include("connect.php");
   $ctable  = "product_inquiry";
   $ctable1     = "product_inquiry";
   ...
   if(isset($_REQUEST['searchName']) && $_REQUEST['searchName']!=""){
       $ctable_where .= " (
                               name like '%".$_REQUEST['searchName']."%' OR contact_no like '%".$_REQUEST['searchName']."%' OR email like '%".$_REQUEST['searchName']."%'
                           ) AND ";
   }
         ...
         <table id="datatable_1" class="table table-striped table-bordered table-hover">
            ...
            <tbody>
               ...
               <tr>
                  ...
                  <td><?php echo $db->rp_getValue("product","name","id='".$ctable_d['product_id']."'",0); ?></td>
                  <!-- <td><?php echo stripslashes($ctable_d['product_name']); ?></td> -->
                  <td><?php echo stripslashes($ctable_d['email']); ?></td>
                  <td><?php echo stripslashes($ctable_d['contact_no']); ?></td>
                  <td><?php echo stripslashes($ctable_d['p_qty']); ?></td>
                  <td><?php echo stripslashes($ctable_d['message']); ?></td>
                  <td><?php echo stripslashes($ctable_d['created_date']); ?></td>
                  <td>
                     <?php
                     ...
                     <?php
                        ...
                        ?>
                     <a class="btn btn-info btn-sm" onClick="window.location.href='<?php echo $ctable; ?>product_inquiry_crud.php?mode=e&id=<?php echo $ctable_d['id']; ?>'" title="Edit"><i class="fa fa-pencil"></i></a> 
                  </td>
               </tr>
               <?php
                  }
