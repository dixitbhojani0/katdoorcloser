<?php
   ...
   $main_page 	= "dashboard";
   $page 		= "application";
   $page_title	= "Add/Edit application";
   $page_hierarchy=array(array("link"=>"dashboard.php","title"=>"Dashboard"),array("link"=>"application_manage.php","title"=>"Manage application"),array("link"=>"application_crud.php","title"=>"Add/Edit application"));
   $success_msg=array();
   $error_msg=array();
   // PAGE DECLARATION
   ...
   $params['name']=trim($db->clean($_REQUEST['title']));
   $params['description']=trim($db->clean($_REQUEST['description']));
   	...
   	if($mode=='a')
   	{
   		...
   		if($reply['ack']==1)
   		{
               ...
               $db->rp_location("application_manage.php");
   		}
   		else
   		{
...
<html lang="en">
   ...
   <head>
      <meta charset="utf-8" />
      <title><?php echo SITETITLE; ?> | Add/Edit application</title>
      ...
      <div class="page-container">
         ...
         <div class="page-content-wrapper">
            ...
            <div class="page-content">
               ...
               <!-- BEGIN PAGE TITLE-->
               <h1 class="page-title"> Add/Edit application
                  <small> Add/Edit application</small>
               </h1>
               <!-- END PAGE TITLE-->
               <!-- END PAGE HEADER-->
               <div class="row">
                  ...
                  <form role="form" action="" method="post" enctype="multipart/form-data">
                     <div class="col-md-12">
                           ...
                           <div class="portlet light bordered">
                              ...
                              <div class="portlet-body form">
                                 <div class="form-group">
                                    ...
                                    <input class="form-control " value="<?php echo $name;  ?>" name="title" id="title" type="text"  data-validation="required,length"   data-validation-length="min3" data-validation-error-msg="Enter atleast 3 Characters." >
                              ...
                              <div class="portlet light bordered">
                                 ...
                                 <div class="form-body">
                                    <div class="row">
                                       <div class="col-sm-12">
                                          <div class="form-group">
                                             <label for="logo">application Image<code>*</code></label>
                                             <input data-image="<?php echo ($image_path!="" && file_exists(application_A.$image_path))?application_A.$image_path:"";?>" type="file" name="image_path" id="image_path" data-old-image-dom="old_image_path" data-old-image-path="<?php echo $image_path ?>" value="" >
                                          </div>
                                       </div>
                                    </div>
                                 </div>   
                        ...
                        <div class="col-md-12">
                           ...
                           <button type="button" class="btn btn-primary" onClick="window.location.href='application_manage.php'">Back</button>
                        </div>
                     </div>
                  </form>
               </div>
